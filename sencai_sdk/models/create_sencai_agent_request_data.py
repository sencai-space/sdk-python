...
class CreateSencaiAgentRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["hostname", "organisation", "cloud_instance", "version", "os", "arch", "enrolled_at", "last_heartbeat_at", "capabilities", "cert_fingerprint", "enrollment_token", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSencaiAgentRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSencaiAgentRequestData from a dict"""
        if obj is None:
            return None
