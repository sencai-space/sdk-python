...
class CreateRemediationRuleRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "incident_pattern", "alert_pattern", "severity_threshold", "runbook", "runbook_id", "auto_approve", "confidence_threshold", "enabled", "cooldown_minutes", "last_triggered_at", "last_fired_at", "fire_count", "organisation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateRemediationRuleRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateRemediationRuleRequestData from a dict"""
        if obj is None:
            return None
