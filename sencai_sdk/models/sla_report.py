...
class SlaReport(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["organisation", "period_start", "period_end", "uptime_percentage", "p1_response_avg_minutes", "p2_response_avg_minutes", "p3_response_avg_minutes", "total_incidents", "p1_incidents", "sla_breached", "breach_details", "credit_percentage", "pdf_url", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SlaReport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SlaReport from a dict"""
        if obj is None:
            return None
