...
class CreateOrganisationRelationshipRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["parent_org", "child_org", "type", "scope", "status", "granted_by", "accepted_by_managed", "expires_at", "notes", "home_region", "cell_id", "billing_model"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateOrganisationRelationshipRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateOrganisationRelationshipRequestData from a dict"""
        if obj is None:
            return None
