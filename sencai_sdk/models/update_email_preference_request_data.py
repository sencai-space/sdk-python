...
class UpdateEmailPreferenceRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["user", "product_updates", "marketing", "digest", "updated_via"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateEmailPreferenceRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateEmailPreferenceRequestData from a dict"""
        if obj is None:
            return None
