...
class CreateAccountTypeRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "description", "price", "limit_user", "public_cloud", "users", "organisations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateAccountTypeRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateAccountTypeRequestData from a dict"""
        if obj is None:
            return None
