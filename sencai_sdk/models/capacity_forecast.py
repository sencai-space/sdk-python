...
class CapacityForecast(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["service", "metric_type", "current_usage", "predicted_peak", "recommended_size", "confidence", "forecast_horizon_days", "model_type", "trend_direction", "organisation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CapacityForecast from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CapacityForecast from a dict"""
        if obj is None:
            return None
