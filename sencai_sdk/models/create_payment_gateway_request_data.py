...
class CreatePaymentGatewayRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["users_permissions_user", "amount", "currency", "state", "payment_method", "stripe_session_id", "stripe_payment_intent_id", "transaction_id", "gateway_response", "error_message", "processed_at", "refunded_at", "refund_amount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatePaymentGatewayRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatePaymentGatewayRequestData from a dict"""
        if obj is None:
            return None
