...
class CreateCodeReviewRequestRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["repo_url", "pr_number", "pr_title", "diff_patch", "status", "review_summary", "issues", "score", "model_used", "organisation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateCodeReviewRequestRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateCodeReviewRequestRequestData from a dict"""
        if obj is None:
            return None
