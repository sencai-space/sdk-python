...
class CookieConsent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["actor_email", "visitor_id", "necessary", "analytics", "marketing", "policy_version", "ip_address", "user_agent", "consented_at", "withdrawn_at", "organisation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CookieConsent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CookieConsent from a dict"""
        if obj is None:
            return None
