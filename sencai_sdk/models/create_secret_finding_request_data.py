...
class CreateSecretFindingRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["repo_name", "repo_provider", "commit_sha", "file_path", "line_number", "rule_id", "rule_description", "severity", "status", "detected_at", "acknowledged_by", "acknowledged_at", "notes", "organisation", "secret_type", "matched_pattern", "context_snippet"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSecretFindingRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSecretFindingRequestData from a dict"""
        if obj is None:
            return None
