...
class K8sAgent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["organisation", "cluster_name", "namespace", "agent_version", "node_count", "status", "last_seen_at", "kubernetes_version", "pod_count", "namespace_count", "connection_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of K8sAgent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of K8sAgent from a dict"""
        if obj is None:
            return None
