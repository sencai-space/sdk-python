...
class CreateCostAllocationRuleRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "provider", "resource_type", "algorithm", "weights", "allocation_tag_key", "effective_from", "is_active", "organisation", "home_region", "cell_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateCostAllocationRuleRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateCostAllocationRuleRequestData from a dict"""
        if obj is None:
            return None
