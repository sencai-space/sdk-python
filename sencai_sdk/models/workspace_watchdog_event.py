...
class WorkspaceWatchdogEvent(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["organisation", "workspace_tenant", "event_type", "severity", "actor_email", "target_email", "resource", "ip_address", "user_agent", "raw_event", "event_data", "status", "notes", "occurred_at", "notification_created"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkspaceWatchdogEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkspaceWatchdogEvent from a dict"""
        if obj is None:
            return None
