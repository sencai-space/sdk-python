...
class CreateWafAclRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["provider", "name", "scope", "default_action", "rules", "capacity", "status", "provider_acl_id", "organisation", "credential"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateWafAclRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateWafAclRequestData from a dict"""
        if obj is None:
            return None
