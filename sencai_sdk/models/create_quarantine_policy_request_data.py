...
class CreateQuarantinePolicyRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "trigger_type", "conditions", "auto_release_hours", "notify_on_trigger", "organisation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateQuarantinePolicyRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateQuarantinePolicyRequestData from a dict"""
        if obj is None:
            return None
