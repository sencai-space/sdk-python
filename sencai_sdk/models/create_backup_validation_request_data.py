...
class CreateBackupValidationRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["backup_type", "source", "size_bytes", "checksum", "validated_at", "restore_test_result", "rto_seconds", "error_message", "organisation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateBackupValidationRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateBackupValidationRequestData from a dict"""
        if obj is None:
            return None
