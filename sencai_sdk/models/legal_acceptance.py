...
class LegalAcceptance(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["legal_document", "user", "organisation", "accepted_at", "ip_address", "user_agent", "document_version", "document_type", "status", "signed_name", "signed_title", "signed_ip", "countersigned_at", "countersigned_by"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LegalAcceptance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LegalAcceptance from a dict"""
        if obj is None:
            return None
