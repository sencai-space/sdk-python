...
class CreateOperatorTimeEntryRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["operator_org", "managed_org", "period", "manual_minutes", "action_count", "computed_minutes", "total_minutes", "notes", "logged_by", "generated_at", "is_sent_to_customer"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateOperatorTimeEntryRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateOperatorTimeEntryRequestData from a dict"""
        if obj is None:
            return None
