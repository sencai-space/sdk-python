...
class SlaBreach(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ticket_id", "ticket_doc_id", "sla_tier", "breach_type", "breached_at", "notified_at", "organisation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SlaBreach from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SlaBreach from a dict"""
        if obj is None:
            return None
