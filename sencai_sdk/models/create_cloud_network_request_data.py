...
class CreateCloudNetworkRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "provider", "region", "cidr_block", "state", "external_id", "metadata", "organisation", "credential", "subnets", "security_groups"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateCloudNetworkRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateCloudNetworkRequestData from a dict"""
        if obj is None:
            return None
