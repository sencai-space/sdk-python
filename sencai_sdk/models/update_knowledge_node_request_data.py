...
class UpdateKnowledgeNodeRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["node_type", "label", "resource_id", "resource_type", "properties", "last_seen_at", "is_active", "organisation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateKnowledgeNodeRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateKnowledgeNodeRequestData from a dict"""
        if obj is None:
            return None
