...
class CreateUserRankRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["user", "xp_total", "rank_level", "badges", "automation_score", "current_streak_days", "longest_streak_days", "last_activity_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateUserRankRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateUserRankRequestData from a dict"""
        if obj is None:
            return None
