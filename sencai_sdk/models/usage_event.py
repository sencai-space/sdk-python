...
class UsageEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["event_type", "quantity", "unit", "resource_id", "resource_type", "idempotency_key", "region", "period_start", "period_end", "organisation", "billed", "billed_at", "metadata"]
