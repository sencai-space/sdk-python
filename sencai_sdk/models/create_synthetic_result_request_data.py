...
class CreateSyntheticResultRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["check_name", "url", "status", "response_time_ms", "status_code", "error_message", "checked_at", "synthetic_check", "organisation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSyntheticResultRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSyntheticResultRequestData from a dict"""
        if obj is None:
            return None
