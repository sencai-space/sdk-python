...
class FindCloudIamPolicy200ResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "provider", "arn_or_policy_id", "policy_document", "is_managed", "external_id", "metadata", "credential", "organisation", "documentId", "id", "createdAt", "updatedAt", "publishedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FindCloudIamPolicy200ResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FindCloudIamPolicy200ResponseDataInner from a dict"""
        if obj is None:
            return None
