...
class FindCloudIamRole200ResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "provider", "arn_or_role_id", "trust_relationship", "attached_policies", "is_managed", "external_id", "metadata", "credential", "organisation", "documentId", "id", "createdAt", "updatedAt", "publishedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FindCloudIamRole200ResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FindCloudIamRole200ResponseDataInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "arn_or_role_id": obj.get("arn_or_role_id"),
            "trust_relationship": obj.get("trust_relationship"),
