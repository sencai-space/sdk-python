...
class FindOneCloudExportJob200ResponseData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["job_id", "status", "organisation", "created_by_user", "resource_count", "skipped_count", "failed_count", "error_message", "output", "providers_included", "documentId", "id", "createdAt", "updatedAt", "publishedAt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FindOneCloudExportJob200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FindOneCloudExportJob200ResponseData from a dict"""
        if obj is None:
            return None
