...
class CreateQuarantineEventRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["agent_id", "agent_name", "trigger_type", "policy_id", "status", "quarantined_at", "released_at", "release_reason", "organisation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateQuarantineEventRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateQuarantineEventRequestData from a dict"""
        if obj is None:
            return None
