...
class CreateWafRuleRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "rule_type", "rule_config", "provider", "provider_rule_id", "enabled", "priority", "last_synced_at", "sync_status", "organisation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateWafRuleRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateWafRuleRequestData from a dict"""
        if obj is None:
            return None
