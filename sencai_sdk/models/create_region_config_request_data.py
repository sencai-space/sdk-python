...
class CreateRegionConfigRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["region", "provider", "display_name", "is_primary", "is_enabled", "replication_target", "latency_ms", "status", "organisation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateRegionConfigRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateRegionConfigRequestData from a dict"""
        if obj is None:
            return None
