...
class CreateDnsRecordRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["zone", "type", "name", "value", "ttl", "weight", "priority", "geo_location", "provider_record_id", "organisation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateDnsRecordRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateDnsRecordRequestData from a dict"""
        if obj is None:
            return None
