...
class OrgOperation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["operation_type", "source_org_id", "target_org_id", "status", "config", "error_message", "initiated_by", "completed_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrgOperation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrgOperation from a dict"""
        if obj is None:
            return None
