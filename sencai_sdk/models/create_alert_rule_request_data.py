...
class CreateAlertRuleRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "metric", "operator", "threshold", "severity", "enabled", "instanceId", "provider", "cooldownMinutes", "notifyEmail", "notifyWebhookUrl", "organisation", "createdBy", "home_region", "cell_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateAlertRuleRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateAlertRuleRequestData from a dict"""
        if obj is None:
            return None
