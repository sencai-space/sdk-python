...
class CreateCustomRegistryRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "url", "username", "token", "organisation", "status", "last_checked", "error_message", "api_url", "is_active", "home_region", "cell_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateCustomRegistryRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateCustomRegistryRequestData from a dict"""
        if obj is None:
            return None
