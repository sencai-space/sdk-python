...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        ...
        "apiTokenAuth": BearerAuthSetting,
        "serviceSecret": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = sencai_sdk.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("sencai_sdk")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if 'serviceSecret' in self.api_key:
            auth['serviceSecret'] = {
                'type': 'api_key',
                'in': 'header',
