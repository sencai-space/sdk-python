...
class ProviderImageCache(BaseModel):
    """
    ProviderImageCache
    """ # noqa: E501
    provider: StrictStr
    ...
    cached_at: datetime
    __properties: ClassVar[List[str]] = ["provider", "image_id", "name", "os_family", "os_version", "architecture", "is_active", "is_lts", "disk_size_gb", "regions", "description", "provider_created_at", "cached_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProviderImageCache from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProviderImageCache from a dict"""
        if obj is None:
            return None
