...
class CreateSyntheticCheckRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "url", "method", "interval_seconds", "timeout_ms", "expected_status", "expected_body_contains", "enabled", "last_check_at", "last_status", "organisation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSyntheticCheckRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSyntheticCheckRequestData from a dict"""
        if obj is None:
            return None
