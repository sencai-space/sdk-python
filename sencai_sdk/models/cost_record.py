...
class CostRecord(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["provider", "service_name", "resource_id", "resource_type", "billed_cost", "list_cost", "currency", "billing_period_start", "billing_period_end", "region", "account_id", "tags", "focus_schema_version", "category", "source", "ingested_at", "organisation", "home_region", "cell_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CostRecord from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CostRecord from a dict"""
        if obj is None:
            return None
