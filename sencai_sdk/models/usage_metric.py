...
class UsageMetric(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["metric_name", "interval", "value", "value_min", "value_max", "sample_count", "period_start", "period_end", "dimension", "organisation", "idempotency_key"]
