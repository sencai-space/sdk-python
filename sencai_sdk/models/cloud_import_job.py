...
class CloudImportJob(BaseModel):
    """
    CloudImportJob
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["job_id", "status", "organisation", "created_by_user", "created_count", "skipped_count", "failed_count", "error_message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CloudImportJob from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CloudImportJob from a dict"""
        if obj is None:
            return None
