...
class CreateCorrelationFindingRequestData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["pattern", "confidence", "affected_services", "evidence_count", "evidence_summary", "finding_type", "status", "first_seen_at", "last_seen_at", "organisation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateCorrelationFindingRequestData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateCorrelationFindingRequestData from a dict"""
        if obj is None:
            return None
